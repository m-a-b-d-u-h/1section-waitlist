  ...
  return (
    <section id="preview" className="w-full py-32 sm:py-40">
      <div className="mx-auto max-w-[800px] px-4 sm:px-6">
        ...
        >
          <p className="mb-4 text-xs font-bold uppercase tracking-[0.15em] text-[#60a5fa]">
            Preview
          </p>
          <h2 className="font-heading text-5xl font-black tracking-[-0.04em] sm:text-6xl">
            Take a look{" "}
            <span className="text-[#60a5fa]">inside</span>
          </h2>
            ...
            >
              ...
              <div className="mt-5 px-1">
                ...
                <div className="ml-9">
                  ...
                  <p className="mt-2 text-sm leading-relaxed" style={{ color: page.color }}>
                    {page.desc}
                  </p>
                </div>
              </div>
